...
app.config["SITE_DESCRIPTION"] = "Votação temática inspirada em Touhou Project! Vote nas suas candidatas e que vença a melhor!"
...
def register_votes():
    ...
    if (presidencia not in allowed_votes["presidencia"]
